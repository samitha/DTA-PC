...
public abstract class Cell {
  ...
  abstract public double getDemand(double total_density, int time_step, double delta_t);

  abstract public double getDerivativeDemand(double total_density, int time_step, 
      double delta_t);
